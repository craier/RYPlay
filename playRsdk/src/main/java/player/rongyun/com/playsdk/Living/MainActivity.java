...
public class MainActivity extends AppCompatActivity {
    ...
    private RYVideoView mVideoView;
    ...
    private void initUi() {
        ...
        mVideoView = (RYVideoView) findViewById(R.id.video_view);
        ...
        mFullScreenIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ScreenRotateUtil.getInstance(MainActivity.this).toggleRotate();
            }
        });
        ...
        mSwitchIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mVideoView != null) {
                    String fileName = FileUtils.getImageCacheDir(MainActivity.this)+System
                            .currentTimeMillis() + "" +
                            ".png";//图片文件名字
                    String path = mVideoView.doShortcut(fileName);
                    if (path == null) {
            ...
            public void onClick(View v) {
                ...
                menuView.setOnMenuClickListener(new OptionMenuView.OnOptionMenuClickListener() {
                    ...
                    public boolean onOptionMenuClick(int position, OptionMenu menu) {
                        Toast.makeText(MainActivity.this, menu.getTitle(), Toast.LENGTH_SHORT)
                                .show();
                        if (mVideoView != null) {
                            if(position==0){
                                mVideoView.setQuickPlay(1);
                                mQuickIv.setText("1X");
                            }else if(position==1){
                                mVideoView.setQuickPlay((float)1.5);
                                mQuickIv.setText("1.5X");
                            }else if(position==2){
                                mVideoView.setQuickPlay((float)2);
                                mQuickIv.setText("2X");
                            }else if(position==3){
                                mVideoView.setQuickPlay((float)0.5);
...
//        }
        mVideoView.setVideoURI(Uri.parse(mUrlPlay));
