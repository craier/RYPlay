...
public class FileUtils {
    ...
    public static final String COM_NAME = "rongyun";
    public static final String APP_NAME = "playsdk";
    public static final String BASE_DIR = File.separator + COM_NAME + File.separator + APP_NAME +
            File.separator;
    public static final String CACHE_DIR = BASE_DIR + "cache" + File.separator;//缓存目录
    public static final String LOCAL_DIR = BASE_DIR + "local" + File.separator;//持久化的文件目录
    public static final String TRACE_DIR = BASE_DIR + "trace" + File.separator;//日志信息
    ...
    public static StringBuilder readFile(String filePath, String charsetName) {
        ...
        if (file != null && file.isFile()) {
            ...
            try {
                ...
                for (String line = null; (line = reader.readLine()) != null; fileContent.append
                        (line)) {
    ...
    public static String getUpdateCacheDir(Context context) {
        ...
        dir += CACHE_DIR + "update" + File.separator;
        File f = new File(dir);
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    public static String getImageCacheDir(Context context) {
        ...
        dir += CACHE_DIR + "images" + File.separator;
        File f = new File(dir);
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    public static String getAudioCacheDir(Context context) {
        ...
        dir += CACHE_DIR + "audios" + File.separator;
        File f = new File(dir);
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    public static String getVideoCacheDir(Context context) {
        ...
        dir += CACHE_DIR + "videos" + File.separator;
        File f = new File(dir);
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    public static void clearLocalFiles(Context context) {
        String dir = getLocalDir(context);
