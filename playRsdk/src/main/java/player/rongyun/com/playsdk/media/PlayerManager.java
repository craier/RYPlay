...
public class PlayerManager {
    ...
    private final RYVideoView videoView;
    ...
    public PlayerManager(final Activity activity) {
        ...
        videoView = (RYVideoView) activity.findViewById(R.id.video_view);
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public RYVideoView getVideoView(){
        if (videoView != null){
            return videoView;
        }
        return null;
