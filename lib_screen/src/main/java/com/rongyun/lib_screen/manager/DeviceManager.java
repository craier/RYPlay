...
public class DeviceManager {
    ...
    private DeviceManageEvent deviceManageEvent;
    ...
    public void setDeviceManageEvent(DeviceManageEvent deviceManageEvent) {
        this.deviceManageEvent = deviceManageEvent;
    }
    ...
    public void addDevice(@NonNull Device device) {
        if (device.getType().equals(DMR_DEVICE)) {
            ...
            if(deviceManageEvent!=null){
                deviceManageEvent.onDeviceManageEvent(new DeviceEvent());
            }
        }
    }
    ...
    public interface DeviceManageEvent {
        void onDeviceManageEvent(DeviceEvent event);
    }
}
